# -*- coding: utf-8 -*-
"""
Created on Mon Nov 20 18:52:13 2020
...
.. module:: TSP
   ...
   :synopsis: Two Objectives Traveling Salesman problem
"""
class TSP(PermutationProblem):
    """ Class representing TSP Problem. """

    def __init__(self, instance: str = None, instance2: str = None):
        super(TSP, self).__init__()

        distance_matrix, number_of_cities = self.__read_from_file(instance)
        cost_matrix, number_of_cities = self.__read_from_file(instance2)
    ...
    def evaluate(self, solution: PermutationSolution) -> PermutationSolution:
        ...
        fitness1 += self.distance_matrix[first_city][last_city]
        fitness2 += self.cost_matrix[first_city][last_city]
