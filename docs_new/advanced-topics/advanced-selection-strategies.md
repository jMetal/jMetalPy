...
!!! note "Under Development"
    This section is planned for future development. The
    [Distance-Based Archive](distance-based-archive.md) provides a concrete example of advanced
    selection strategies.

## Overview

Selection strategies determine which solutions to maintain in archives and populations during
optimization. Advanced strategies can significantly improve optimization performance.
...
The [Distance-Based Archive](distance-based-archive.md) demonstrates several advanced concepts:
...
- [Distance-Based Archive](distance-based-archive.md) — practical implementation example
- [Custom Archives](custom-archives.md) — building custom archive types
- [Utilities API](../api/util.md) — Archive API reference
