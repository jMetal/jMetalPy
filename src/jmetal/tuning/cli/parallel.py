...
Usage:
    ...
    python -m jmetal.tuning.cli.parallel --workers 8 --trials 1000
    python -m jmetal.tuning.cli.parallel --workers 4 --no-clean  # Resume existing study
    python -m jmetal.tuning.cli.parallel --workers 4 --observer progress  # With clean output

Examples:
    # 4 workers, clean DB, 500 total trials (default)
    python -m jmetal.tuning.cli.parallel -w 4
