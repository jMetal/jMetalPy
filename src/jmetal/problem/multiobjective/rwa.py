...
class Ahmad2017(FloatProblem):
    ...
    def evaluate(self, solution: FloatSolution) -> FloatSolution:
        ...
        wca = (
            -1331.04 + 1.99 * x1 + 0.33 * x2 + 17.12 * x3 - 0.02 * x1 * x1 - 0.05 * x3 * x3 - 15.33
        )
        oca = (
            -4231.14
            + 4.27 * x1
        ...
        cra = (
            -2342.13 - 1.556 * x1 + 0.77 * x2 + 31.14 * x3 + 0.03 * x1 * x1 - 0.10 * x3 * x3 - 73.33
        )
        stiffness = (
            9.34 + 0.02 * x1 - 0.03 * x2 - 0.03 * x3 - 0.001 * x1 * x2 + 0.0009 * x2 * x2 + 0.22
        )
        tear = (
            1954.71
            + 14.246 * x1
        ...
        tensile = (
            828.16 + 3.55 * x1 + 73.65 * x2 + 10.80 * x3 - 0.56 * x2 * x3 + 0.20 * x2 * x2 - 2814.83
        )
