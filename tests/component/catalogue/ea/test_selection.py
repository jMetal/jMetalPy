...
from jmetal.component.catalogue.ea.selection import RandomSelection, Selection, TournamentSelection
...
class TestRandomSelection:
    ...
    def test_returns_a_mating_pool_of_the_requested_size(self):
        operator = RandomSelectionOperator()
        selection = RandomSelection(operator, mating_pool_size=6)
    ...
    def test_selected_solutions_come_from_the_population(self):
        operator = RandomSelectionOperator()
        selection = RandomSelection(operator, mating_pool_size=4)
        population = self._population()
