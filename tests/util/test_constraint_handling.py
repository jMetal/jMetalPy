...
class ConstraintHandlingTestCases(unittest.TestCase):
    def test_should_is_feasible_return_true_if_the_solution_has_no_constraints(self) -> None:
        solution = FloatSolution(
            [0.0, 0.0], [1.0, 1.0], number_of_objectives=2, number_of_constraints=0
        )

        self.assertEqual(True, is_feasible(solution))

    def test_should_is_feasible_return_true_if_the_solution_has_constraints_and_is_feasible(
        self,
    ) -> None:
        solution = FloatSolution(
            [0.0, 0.0], [1.0, 1.0], number_of_objectives=2, number_of_constraints=1
        )
    ...
    def test_should_number_of_violated_constraints_return_zero_if_the_solution_has_no_constraints(
        self,
    ) -> None:
        solution = FloatSolution(
            [0.0, 0.0], [1.0, 1.0], number_of_objectives=2, number_of_constraints=0
    ...
    def test_should_number_of_violated_constraints_return_zero_if_the_solution_has_not_violated_constraints(
        ...
        solution = FloatSolution(
            [0.0, 0.0], [1.0, 1.0], number_of_objectives=2, number_of_constraints=2
        )
    ...
    def test_should_number_of_violated_constraints_return_the_right_number_of_violated_constraints(
        self,
    ) -> None:
        solution = FloatSolution(
            [0.0, 0.0], [1.0, 1.0], number_of_objectives=2, number_of_constraints=3
        )
    ...
    def test_should_feasibility_ratio_return_one_if_all_the_solutions_in_a_list_are_feasible(
        self,
    ) -> None:
        solution1 = FloatSolution(
            [0.0, 0.0], [1.0, 1.0], number_of_objectives=2, number_of_constraints=0
        )
        solution2 = FloatSolution(
            [0.0, 0.0], [1.0, 1.0], number_of_objectives=2, number_of_constraints=0
        )
        solution3 = FloatSolution(
            [0.0, 0.0], [1.0, 1.0], number_of_objectives=2, number_of_constraints=0
        )
