...
class DistanceMetricTestCase(unittest.TestCase):
    ...
    def test_distance_calculation_with_numpy_arrays(self):
        ...
        distance_linf = DistanceCalculator.calculate_distance(arr1d_1, arr1d_2, DistanceMetric.LINF)
    ...
    def test_zero_distance(self):
        ...
        # L2_SQUARED
        distance_l2 = DistanceCalculator.calculate_distance(point, point, DistanceMetric.L2_SQUARED)
        self.assertAlmostEqual(0.0, distance_l2, places=6)

        # LINF
        distance_linf = DistanceCalculator.calculate_distance(point, point, DistanceMetric.LINF)
