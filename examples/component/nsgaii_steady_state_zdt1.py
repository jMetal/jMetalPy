...
"""
Program to configure and run a steady-state version of the component-based NSGA-II
(offspring_population_size=1), the same configuration as
examples/multiobjective/nsgaii/nsgaii_steady_state.py. Exercises
CrossoverAndMutationVariation's mating-pool-size arithmetic at its smallest useful
offspring size.
"""
